<template>
  <div 
    :class="[
      'toast-notification max-w-sm px-4 py-3 rounded-lg shadow-lg flex items-center gap-3',
      typeClasses,
    ]"
    role="alert"
    @click="$emit('close')"
  >
    ...
    <button 
      ...
      class="flex-shrink-0 ml-auto text-gray-400 hover:text-gray-500 focus:outline-none"
    >
...
// Compute CSS classes based on notification type
